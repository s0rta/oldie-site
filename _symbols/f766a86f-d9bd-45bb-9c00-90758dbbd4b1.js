...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-16hs2k6");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
			toggle_class(a, "focused", /*link*/ ctx[8].label === /*cur_page*/ ctx[1]);
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-16hs2k6");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-16hs2k6");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-16hs2k6");
			attr(nav, "class", "svelte-16hs2k6");
			attr(div0, "class", "desktop-nav svelte-16hs2k6");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-16hs2k6");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-16hs2k6");
			attr(header, "class", "section-container svelte-16hs2k6");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if ((!current || dirty & /*logo*/ 1) && t0_value !== (t0_value = /*logo*/ ctx[0].title + "")) set_data(t0, t0_value);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('cur_page' in $$props) $$invalidate(1, cur_page = $$props.cur_page);
		if ('site_nav' in $$props) $$invalidate(2, site_nav = $$props.site_nav);
	};

	return [logo, cur_page, site_nav, mobileNavOpen, props, click_handler, click_handler_1];
}
